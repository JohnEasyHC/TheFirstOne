		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form action="routes.php" method="post" class="animated wow slideInUp" data-wow-delay=".5s">
					<input type="text" name="first_name" placeholder="Unesite ime" required=" " >
					<input type="text" name="last_name" placeholder="Unesite prezime" required=" " >
				</form>
				...
				<form action="routes.php" method="post"class="animated wow slideInUp" data-wow-delay=".5s">
					...
					<input type="password" name="cpassword" placeholder="Potvrda lozinke" required=" " >
